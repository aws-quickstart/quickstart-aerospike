...
You can deploy either a single-node or three-node cluster. For more information, see https://aerospike.com/products/aerospike-quick-start-for-aws/[Aerospike Quick Start for AWS^]. 
